...
e.put("decorators/material/fieldset-trcl.html",'<fieldset ng-disabled="form.readonly" class="standard {{form.htmlClass}}" flex=""><legend ng-show="form.title">{{ form.title }}</legend><div ng-transclude=""></div></fieldset>'),e.put("decorators/material/fieldset.html",'<fieldset ng-disabled="form.readonly" class="standard {{form.htmlClass}}" flex=""><legend ng-show="form.title">{{ form.title }}</legend></fieldset>'),e.put("decorators/material/help.html",'<div class="helpvalue schema-form-helpvalue {{form.htmlClass}}" ng-bind-html="form.helpvalue"></div>'),e.put("decorators/material/radio-buttons.html",'<div class="form-group schema-form-radiobuttons {{form.htmlClass}}" ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess()}" sf-layout="" sf-messages=""><div><label class="control-label" ng-show="showTitle()">{{form.title}}</label></div><section layout="row" layout-sm="column" layout-align="center center"><md-input-container ng-repeat="item in form.titleMap"><md-button type="button" class="group md-raised" sf-field-model="replaceAll" ng-model="$$value$$" sf-changed="form" ng-class="{\'md-primary\': ($$value$$ == item.value)}" ng-disabled="form.readonly" ng-model-options="form.ngModelOptions" schema-validate="form" ng-value="item.value" ng-click="$$value$$ = item.value" name="{{form.key.join(\'.\')}}"><span ng-bind-html="item.name"></span></md-button></md-input-container></section></div>'),e.put("decorators/material/radios-inline.html",'<div class="form-group schema-form-radios-inline {{form.htmlClass}}" ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess()}" sf-layout="" sf-messages=""><label class="control-label" ng-show="showTitle()">{{form.title}}</label><md-radio-group layout="row" sf-field-model="replaceAll" ng-model="$$value$$" class="{{form.fieldHtmlClass}}" ng-class="{ active: item.value === $$value$$ }" sf-changed="form" schema-validate="form" ng-disabled="form.readonly" name="{{form.key.join(\'.\')}}"><md-radio-button ng-repeat="item in form.titleMap" ng-value="item.value"><span ng-bind-html="item.name"></span></md-radio-button></md-radio-group></div>'),e.put("decorators/material/radios.html",'<div class="form-group schema-form-radios {{form.htmlClass}}" ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess()}"><label class="control-label" ng-show="showTitle()" aria-label="{{form.title}}" layout="row">{{form.title}} {{form.titleMap | json}}</label><div><md-radio-group sf-field-model="" sf-changed="form" ng-disabled="form.readonly" name="{{form.key.join(\'.\')}}" sf-layout="" sf-messages=""><md-radio-button ng-repeat="item in form.titleMap" ng-value="item.value" class="{{form.fieldHtmlClass}}" sf-field-model="ng-class" ng-class="{ active: item.value === $$value$$ }"><span ng-bind-html="item.name"></span></md-radio-button></md-radio-group></div></div>'),e.put("decorators/material/section.html",'<md-content class="schema-form-section {{::form.htmlClass}}" sf-layout=""></md-content>'),e.put("decorators/material/select.html",'<md-input-container class="form-group {{::form.htmlClass}} schema-form-select" ng-class="{\'has-error\': hasError(), \'has-success\': hasSuccess(), \'has-feedback\': form.feedback !== false}" sf-messages="" sf-layout=""><label ng-show="::showTitle()">{{::form.title}}</label><md-select sf-field-model="" schema-validate="form"><md-optgroup ng-repeat-start="(key, opt) in form.getOptions(form, evalExpr) | orderBy:\'group\' as optGroups" ng-if="opt.group && opt.group != optGroups[key-1].group" label="{{::opt.group}}" aria-label="{{::opt.group}}"><md-option ng-repeat="(key, filtered) in form.getOptions(form, evalExpr) | filter: {group: opt.group} | orderBy:\'name\' as opts" ng-value="::filtered.value" aria-label="{{::filtered.name}}">{{::filtered.name}}</md-option></md-optgroup><md-option ng-if="!opt.group" ng-value="::opt.value" ng-repeat-end="">{{::opt.name}}</md-option></md-select></md-input-container>'),e.put("decorators/material/slider.html",'<md-input-container class="schema-form-slider {{form.htmlClass}}"><label ng-show="showTitle()" for="{{::form.key|sfCamelKey}}">{{::form.title}}</label><md-slider sf-field-model="" flex="" id="{{::form.key|sfCamelKey}}" min="0" max="255" aria-label="blue"></md-slider></md-input-container>'),e.put("decorators/material/submit.html",'<section class="schema-form-submit {{form.htmlClass}}" sf-messages=""><md-button class="md-raised {{ form.style || \'md-primary\' }} {{form.fieldHtmlClass}}" type="{{::form.type}}" ng-disabled="form.readonly" aria-label="{{::form.title}}"><md-tooltip ng-if="::form.tip">{{::form.tip}}</md-tooltip>{{::form.title}}</md-button></section>'),e.put("decorators/material/switch.html",'<md-input-container class="schema-form-switch {{::form.htmlClass}}"><md-switch sf-field-model="" sf-changed="form" sf-type-parser="form.schema" sf-messages="" schema-validate="form" id="{{::form.key|sfCamelKey}}" aria-label="{{form.title}}" ng-show="::form.key" ng-class="form.fieldHtmlClass" ng-disabled="::form.readonly"><span ng-show="showTitle()" for="{{::form.key|sfCamelKey}}">{{::form.title}}</span></md-switch></md-input-container>'),e.put("decorators/material/tabarray.html",'<div sf-array="form" ng-init="selected = { tab: 0 }" class="clearfix schema-form-tabarray schema-form-tabarray-{{form.tabType || \'left\'}} {{form.htmlClass}}"><div ng-if="!form.tabType || form.tabType !== \'right\'" ng-class="{\'col-xs-3\': !form.tabType || form.tabType === \'left\'}"><ul class="nav nav-tabs" ng-class="{ \'tabs-left\': !form.tabType || form.tabType === \'left\'}"><li ng-repeat="item in modelArray track by $index" ng-click="$event.preventDefault() || (selected.tab = $index)" ng-class="{active: selected.tab === $index}"><a href="#">{{interp(form.title,{\'$index\':$index, value: item}) || $index}}</a></li><li ng-hide="form.readonly" ng-click="$event.preventDefault() || (selected.tab = appendToArray().length - 1)"><a href="#"><i class="glyphicon glyphicon-plus"></i> {{ form.add || \'Add\'}}</a></li></ul></div><div ng-class="{\'col-xs-9\': !form.tabType || form.tabType === \'left\' || form.tabType === \'right\'}"><div class="tab-content {{form.fieldHtmlClass}}"><div class="tab-pane clearfix" ng-repeat="item in modelArray track by $index" ng-show="selected.tab === $index" ng-class="{active: selected.tab === $index}"><sf-decorator ng-init="arrayIndex = $index" form="copyWithIndex($index)"></sf-decorator><button ng-hide="form.readonly" ng-click="selected.tab = deleteFromArray($index).length - 1" type="button" class="btn {{ form.style.remove || \'btn-default\' }} pull-right"><i class="glyphicon glyphicon-trash"></i> {{ form.remove || \'Remove\'}}</button></div></div></div><div ng-if="form.tabType === \'right\'" class="col-xs-3"><ul class="nav nav-tabs tabs-right"><li ng-repeat="item in modelArray track by $index" ng-click="$event.preventDefault() || (selected.tab = $index)" ng-class="{active: selected.tab === $index}"><a href="#">{{interp(form.title,{\'$index\':$index, value: item}) || $index}}</a></li><li ng-hide="form.readonly" ng-click="$event.preventDefault() || appendToArray()"><a href="#"><i class="glyphicon glyphicon-plus"></i> {{ form.add || \'Add\'}}</a></li></ul></div></div>'),e.put("decorators/material/tabs.html",'<div sf-field-model="" class="schema-form-tabs {{::form.htmlClass}}"><md-tabs md-dynamic-height="" md-selected="selected" md-autoselect="" ng-init="selected = 0"></md-tabs></div>'),e.put("decorators/material/textarea.html",'<md-input-container class="{{::form.htmlClass}} schema-form-textarea" sf-messages="" sf-layout=""><label ng-show="showTitle()" for="{{::form.key|sfCamelKey}}">{{::form.title}}</label> <textarea ng-class="::form.fieldHtmlClass" id="{{::form.key|sfCamelKey}}" sf-changed="form" ng-disabled="::form.readonly" sf-field-model="" schema-validate="form" name="{{::form.key|sfCamelKey}}"></textarea></md-input-container>')}]),angular.module("schemaForm").directive("sfMaterialClass",function(e,a){return{restrict:"A",scope:!1,link:function(e,t,s,l){function r(e,a){return e[a]}var o;try{o=e.form.key.reduce(r,e.model)}catch(m){o=void 0}a(function(){null!==o&&"undefined"!=typeof o&&o!==!1&&t.addClass(s.sfMaterialClass)},0)}}}),function(e,a){"use strict";function t(e,a,t,r,o){function m(e){var a=e.fieldFrag.querySelector("[sf-layout]");e.form.grid&&Object.getOwnPropertyNames(e.form.grid).forEach(function(t,s,l){a.setAttribute(t,e.form.grid[t])})}function i(){var e='<div ng-if="ngModel.$invalid" ng-messages="{dummy: true}" class="ng-active"><div ng-message="dummy" class="md-input-message-animation" sf-message="form.description"></div></div>',a=document.createElement("div");return a.innerHTML=e,a.firstChild}function d(e){var a=e.fieldFrag.querySelector("[sf-messages]");if(a&&T){var t=T.cloneNode(!0);a.appendChild(t)}}function n(e){var a=e.fieldFrag.querySelector("textarea"),t=e.form.maxlength||!1;a&&t&&a.setAttribute("md-maxlength",t)}function c(e){var a=e.fieldFrag.querySelector("md-autocomplete"),t=e.form.minLength||1,s=e.form.maxLength||!1,l=e.form.title||e.form.placeholder||e.form.key.slice(-1)[0];a&&(e.form.onChange&&(a.setAttribute("md-selected-item-change","args.form.onChange()"),a.setAttribute("md-search-text-change","args.form.onChange(searchText)")),a.setAttribute("md-min-length",t),s&&a.setAttribute("md-max-length",s),l&&a.setAttribute("md-floating-label",l))}function f(e){var a=e.fieldFrag.querySelector("md-switch");e.form.schema.titleMap&&(a.setAttribute("ng-true-value",e.form.schema.titleMap["true"]),a.setAttribute("ng-false-value",e.form.schema.titleMap["false"]))}function h(e){var a,t,t=e.fieldFrag.querySelector("md-select");if(e.form.selectOptions=[],e.form.getOptions=s,e.form.schema.links&&"object"==typeof e.form.schema.links){var r,o=/({)([^}]*)(})/gm;for(a=0;a<e.form.schema.links.length;a++)r=e.form.schema.links[a],"options"===r.rel&&(e.form.optionSource=r.href.replace(o,"$1$1 model.$2 $3$3"));t.setAttribute("sfm-external-options",e.form.optionSource)}else e.form.selectOptions=l(e.form)}function p(e){var a=e.fieldFrag.querySelector("md-datepicker");if(a){e.form.onChange&&a.setAttribute("ng-change","args.form.onChange(searchText)");var t=e.form.minimum||!1,s=e.form.maximum||!1;t&&a.setAttribute("md-min-date",t),s&&a.setAttribute("md-max-date",s)}}function u(e){if(e.form.tabs&&e.form.tabs.length>0){var a=e.fieldFrag.querySelector("md-tabs");e.form.tabs.forEach(function(t,s){var l=document.createElement("md-tab");l.setAttribute("label","{{"+e.path+".tabs["+s+"].title}}");var r=document.createElement("md-tab-body"),o=e.build(t.items,e.path+".tabs["+s+"].items",e.state);r.appendChild(o),l.appendChild(r),a.appendChild(l)})}}function g(a,t,s){if("string"===t.type&&("date"===t.format||"date-time"===t.format)){var l=e.stdFormObj(a,t,s);return l.key=s.path,l.type="date",s.lookup[r.stringify(s.path)]=l,l}}var b="decorators/material/",y=t.builders.simpleTransclusion,v=t.builders.ngModelOptions,x=t.builders.ngModel,$=t.builders.sfField,k=t.builders.condition,C=t.builders.array,w=t.builders.numeric,m=m,T=i(),A=d,E=h,M=c,K=f,S=p,F=u,H=n,O=[$,x,v,k,m],j=O.concat(A),D=O.concat(C);e.defaults.string.unshift(g),a.defineDecorator("materialDecorator",{actions:{template:b+"actions.html",builder:[$,y,k]},array:{template:b+"array.html",builder:D},autocomplete:{template:b+"autocomplete.html",builder:j.concat(M)},"boolean":{template:b+"checkbox.html",builder:j},button:{template:b+"submit.html",builder:j},checkbox:{template:b+"checkbox.html",builder:j},checkboxes:{template:b+"checkboxes.html",builder:D},date:{template:b+"date.html",builder:j.concat(S)},"default":{template:b+"default.html",builder:j},fieldset:{template:b+"fieldset.html",builder:[$,y,k]},help:{template:b+"help.html",builder:j},number:{template:b+"default.html",builder:j.concat(w)},password:{template:b+"default.html",builder:j},radios:{template:b+"radios.html",builder:j},"radios-inline":{template:b+"radios-inline.html",builder:j},radiobuttons:{template:b+"radio-buttons.html",builder:j},section:{template:b+"section.html",builder:[$,y,k,m]},select:{template:b+"select.html",builder:j.concat(E)},submit:{template:b+"submit.html",builder:j},tabs:{template:b+"tabs.html",builder:[$,F,k]},tabarray:{template:b+"tabarray.html",builder:D},textarea:{template:b+"textarea.html",builder:j.concat(H)},"switch":{template:b+"switch.html",builder:j.concat(K)}})}function s(e,a){return e.optionData?a(e.optionData):e.selectOptions?e.selectOptions:[]}function l(e){var a=[];if(e.titleMap)return e.titleMap;if(e["enum"]&&e["enum"].length)for(i=0;i<e["enum"].length;i++)e["enum"][i]&&e["enum"][i].length&&a.push({name:e["enum"][i],value:e["enum"][i]});return a}function r(e){function a(a,t,s){s.$observe("sfmExternalOptions",function(t){e.get(t).then(function(e){a.form.selectOptions=l(e.data)})})}var t={link:a,restrict:"A"};return t}function o(){return function(e){if(!e)return"";var a,t,s;for(s=e.slice(),t=0;t<s.length;t++)a=s[t].toLowerCase().split(""),t&&a.length&&(a[0]=a[0].toUpperCase()),s[t]=a.join("");return s.join("")}}e.module("schemaForm").config(t).directive("sfmExternalOptions",r).filter("sfCamelKey",o),t.$inject=["schemaFormProvider","schemaFormDecoratorsProvider","sfBuilderProvider","sfPathProvider","$injector"],r.$inject=["$http"]}(angular,void 0),angular.module("schemaForm").directive("sfTypeParser",function(){return{restrict:"A",scope:!1,require:"ngModel",link:function(e,a,t,s){var l=e.$watch(t.sfTypeParser,function(e){if(e){var a=e.type.indexOf("number")!==-1,t=e.type.indexOf("integer")!==-1,r=/^[0-9]*$/;(a||t)&&s.$parsers.push(function(e){var t;return a?t=parseFloat(e):r.test(e)&&(t=parseInt(e,10)),console.log("parser",r.test(e),e,t),void 0===t||isNaN(t)?e:t}),l()}})}}});